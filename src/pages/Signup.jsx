  ...
  return (
    <section className="bg-gray-900">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div className="overflow-auto w-full bg-gray-800 rounded-lg shadow border md:mt-0 md:mt-0 md:w-1/2 2xl:w-1/3 xl:p-0 border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="/sign-up" method="post" onSubmit={(e) => handleSubmit(e)}>
              ...
              <div>
                <label htmlFor="username" className="block mb-2 text-sm md:text-lg font-medium text-gray-900 text-white">Your Username</label>
                <input
                  type="text"
                  name="username"
              ...
              <div>
                <label htmlFor="password" className="block mb-2 text-sm md:text-lg font-medium text-gray-900 text-white">Password</label>
                <input
                  type="password"
                  name="password"
                  onChange={(e) => handleChange(e)}
              ...
              <div>
                <label htmlFor="email" className="block mb-2 text-sm md:text-lg font-medium text-gray-900 text-white">Email</label>
                <input
                  type="email"
                  name="email"
                  onChange={(e) => handleChange(e)}
              ...
              <div>
                <label htmlFor="name" className="block mb-2 text-sm md:text-lg font-medium text-gray-900 text-white">Name</label>
                <input
                  type="text"
                  name="name"
                  onChange={(e) => handleChange(e)}
              ...
              <div>
                <label htmlFor="gender" className="block mb-2 text-sm md:text-lg font-medium text-gray-900 text-white">Gender</label>
                <select
                  name="gender"
                  onChange={(e) => handleChange(e)}
              ...
              <div>
                <label htmlFor="birthdate" className="block mb-2 text-sm md:text-lg font-medium text-gray-900 text-white">Birthdate</label>
                <input
                  type="date"
                  name="birthdate"
                  onChange={(e) => handleChange(e)}
              ...
              <Button disabled={loading} variant="outlined" size="xl" fullWidth="true" className="text-white" type="submit" >Sign Up</Button>
            </form>
          </div>
        </div>
      </div>
