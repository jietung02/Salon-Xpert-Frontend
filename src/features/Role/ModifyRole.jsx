...
export default function ModifyRole() {
  ...
  return (
    <div>
      <form className="my-4 container mx-auto w-5/6 bg-gray-50 rounded-lg shadow-md shadow-gray-300 flex flex-wrap md:items-end gap-8 px-12 py-12 mx-auto" onSubmit={(e) => handleSubmitForEditRole(e)}>
        ...
        <Dropdown disabled={roleDetails.roleIsServiceProvider !== null} isSelected={roleDetails.roleIsServiceProvider} label='Is Service Provider' name='roleIsServiceProvider' handleOnChange={updateRoleDetails} options={[{ label: '', value: '' }, { label: 'Yes', value: '1' }, { label: 'No', value: '0' }]} />
