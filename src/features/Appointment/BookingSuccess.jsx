...
export default function BookingSuccess() {
  ...
  return (
    <div>
      ...
      <form className="my-10 container mx-auto w-5/6 bg-gray-100 rounded-lg shadow-md shadow-gray-200 flex flex-wrap md:items-end gap-8 px-12 py-12 mx-auto" >
        <span className="relative w-full h-10 flex items-center justify-center">
        <CheckCircleIcon className="h-20 w-20" color="green"/>
        </span>
        
        <div className="relative w-full h-10 flex items-center justify-center mb-4">
          <span className="font-bold text-xl text-gray-900">Appointment Booked Successfully</span>
        </div>
