...
export default function CreateAppointment() {
  ...
  const { appointDetails, services, specialists, updateAppointmentDetails, resetAppointmentDetails, bookAppointment, fetchServices, fetchSpecialists, setSpecialists } = useAppontmentBooking();
  ...
  return (
    <div>
      ...
      <form className="my-6 container mx-auto w-5/6 bg-gray-100 rounded-lg shadow-md shadow-gray-200 flex flex-wrap md:items-end gap-8 px-12 py-12 mx-auto" onSubmit={handleSubmit}>
