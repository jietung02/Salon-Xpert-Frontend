...
export default function CreateStaffProfile() {
  ...
  const { profileDetails, updateProfileDetails } = useContext(StaffProfileContext);
  const { loading, error, handleSubmitForStaffCreation, } = useStaffProfileConfiguration();
  return (
    <div>
      <form className="my-4 container mx-auto w-5/6 bg-gray-50 rounded-lg shadow-md shadow-gray-300 flex flex-wrap md:items-end gap-8 px-12 py-12 mx-auto" onSubmit={(e) => handleSubmitForStaffCreation(e)}>
        <div className="relative w-full">
          <div className="flex justify-center items-center mb-4 h-16">
            <span className="font-bold text-xl text-gray-900">New Staff Profile</span>
          </div>
