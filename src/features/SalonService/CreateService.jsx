...
export default function CreateService() {
  ...
  return (
    <div>
      <form className="my-4 mx-auto w-4/5 bg-gray-50 rounded-lg shadow-md shadow-gray-300 flex flex-wrap md:items-end gap-8 px-12 py-12" onSubmit={(e) => handleSubmitForCreation(e)}>
